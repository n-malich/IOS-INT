...
class Posts {
    ...
    [
        Post(id: UUID(),
             author: "Пикабу",
             body: "Во время уборки пляжа волонтеры и работники обычно собирают крупные отходы, например пластиковые бутылки или упаковку. Но песок часто захламляют более мелкими фрагментами пластика, окурками, обломками контейнеров и стаканчиков. Отсеивать такие кусочки пластика от песка — это гигантская задача. Новый робот под названием BeBot разработан, чтобы помочь собрать эти мелкие пластиковые отходы.",
             //image: "4ocean",
...
//             filter: .sepia(intensity: 0.8),
        ...
        Post(id: UUID(),
             author: "Лепра",
             body: "«Я пpocтo жapил pыбoв нa гpилe нa зaднeм двope, кaк вдpyг пoявилcя oн».",
             //image: "cat",
